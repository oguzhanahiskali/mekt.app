...
<body class="horizontal-layout horizontal-menu  navbar-floating footer-static  " data-open="hover" data-menu="horizontal-menu" data-col="">
                    ...
                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-2 col-sm-6 col-12 mb-2 mb-xl-0">
                                            <div class="d-flex flex-row">
                                                ...
                                                <div class="my-auto">
                                                    <h4 class="fw-bolder mb-0" id="toplamSeans"></h4>
                                                    <p class="card-text font-small-3 mb-0">Toplam Seans</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-2 col-sm-6 col-12 mb-2 mb-xl-0">
                                            <div class="d-flex flex-row">
                                                ...
                                                <div class="my-auto">
                                                    <h4 class="fw-bolder mb-0" id="SeansIptal"></h4>
                                                    <p class="card-text font-small-3 mb-0">İptal</p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="card-content">
                                    <div class="card-body pb-0">
                                        <div class="d-flex justify-content-start">
                                            ...
                                            <!-- <div class="col-md-2 text-center">
                                                <p class="mb-50 text-bold-600">Bu Ay (Ürün)</p>
                                                <p class="font-small-1" id="thisMonthProduct" title="Ürün"></p>
                                                <h2 class="text-bold-400">
                                                    <sup class="font-medium-1">₺</sup>
                                                        <span class="text-success" id="thisMonthProduct">0</span>
                                                </h2>
                                            </div>
                                            <div class="col-md-2 text-center">
                                                <p class="mb-50 text-bold-600">Bu Ay (Hizmet)</p>
                                                <h2 class="text-bold-400">
                                                    <sup class="font-medium-1">₺</sup>
                                                        <span class="text-success" id="thisMonthService">0</span>
                                                </h2>
                                            </div> -->
                                            <div class="col-md-2 text-center">
                                            ...
                                            <!-- <div class="col-md-2 text-center">
                                                <p class="mb-50 text-bold-600">Geçen Ay (Ürün)</p>
                                                <h2 class="text-bold-400">
                                                    <sup class="font-medium-1">₺</sup>
                                                        <span id="lastMonthProduct">0</span>
                                                    </span>
                                                </h2>
                                            </div>
                                            <div class="col-md-2 text-center">
                                                <p class="mb-50 text-bold-600">Geçen Ay (Hizmet)</p>
                                                <h2 class="text-bold-400">
                                                    <sup class="font-medium-1">₺</sup>
                                                        <span id="lastMonthService">0</span>
                                                    </span>
                                                </h2>
                                            </div> -->
                                        </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-12">
                            <div class="card">
                                ...
                                <div class="card-body d-flex justify-content-between align-items-start flex-column">
                                    <button class="btn btn-primary w-100 box-shadow-1 mt-2">Ciro Dökümü <i class="feather icon-chevrons-right"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php $query = $db->query("SELECT * FROM view_today_sendSMS WHERE FIRMA_ID = {$user_Firma} LIMIT 6", PDO::FETCH_ASSOC);
                                            if($query->rowCount()){
                                        ...
                                        <table id="randevus" class="table table-hover-animation mb-0" style="margin-bottom:25px!important">
                                            ...
                                            <tbody style="text-align:center">
                                                <?php // where durum 1 eklendi. 11/06/2019
													...
													$query = $db->query("SELECT * FROM view_test_takvim
                                                                        WHERE
                                                                        FIRMA_ID = '$user_Firma' AND
                                                                        (DATE(START) = CURDATE() OR
                                                                        DATE(KONTROL_START) = CURDATE())
                                                                        ORDER BY DDD ASC", PDO::FETCH_ASSOC);
                                                    $countSeansSayisi = 0;
                                                    $countBekleyen = 0;
                                                    $countGelmeyen = 0;
                                                    $countGelen = 0;
													...
													if ( $query->rowCount() )
													{
														...
														foreach( $query as $row )
														{
                                                            ...
                                                            $UygulamaBolgesi= "";
                                                            if(strlen($row['HIZMET_BOLGE'])>0){
                                                                $hizmetBolgeler = $row['HIZMET_BOLGE'];
                                                                if (strpos($hizmetBolgeler, ',') === true) {
															...
															print '<td>'.$row['ESTETISYENADI'].' '.substr($row['ESTETISYENSOYADI'], 0,1).'.</td>';
															print '<td>'.$row['RESOURCE_NAME'].'</td>';
															print '<td>'.$row['TITLE'].'<b>'.$UygulamaBolgesi.'</b></td>';
    ...
    <script>
        $(document).ready(function() {
            setTimeout(function(){
                $(document).prop('title', i18next.t("Title index php")+" | EstetikPanel v2");
            }, 1500);
        });
    ...
    <script>
        ...
        $("#toplamSeans").html(0);
        $("#SeansGelmeyen").html(0);
        $("#SeansGelen").html(0);
        $("#SeansIptal").html(0);
        $("#SeansBekleyen").html(0);
        $("#completed").html(0);
        $("#waiting").html(0);
    </script>
</body>
