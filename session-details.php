                                                                    ...
                                                                    <div class="card-content collapse show">
                                                                        <div class="card-body">
                                                                            <form id="FormEditSeans"
                                                                                    ...
                                                                                    if($user_Firma==176){
                                                                                        ?>
                                                                                            <fieldset id="myDiv" class="border col-md-12 mb-1 img-wrapper" style="max-height: 32em;">
                                                                                                <legend class="w-auto">Görsel Yükleme Alanı</legend>
                                                                                ...
                                                                                ?>
                                                                                <fieldset id="AppRegFieldset" class="border col-md-12 mb-1" data-html="true" data-toggle="tooltip" data-original-title="Dikkat!</br> En az bir <b>uygulama bölgesi</b> seçim zorunludur. <u><i>Bölge seçimi yalnızca bu seansı ilgilendirdiğini lütfen unutmayın.</i></u>">
                                                                                ...
                                                                                <fieldset class="border col-md-12 mb-1 pb-1">
                                                                                    ...
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-md-3">
                                                                                            <div class="form-group">
                                                                                                <label for="OdaSecimi">Oda Seçimi: <span class="danger">*</span></label>
                                        ...
                                        <div class="tab-content pt-1 col-md-12">
                                            <div class="tab-pane fade show active" id="session-schedule" role="tabpanel" aria-labelledby="session-schedule-tab">
                                                <?php foreach (yetkiSor($kullaniciadi) as $yetki);
                                                    ...
                                                    <button type="button" class="btn btn-danger round btn-sm float-right mb-3" data-toggle="modal" data-target="#SeansEditDIV">Seans Ekle / Çıkar</button>
                                                <?php } ?>
                                            </div>
                                            <div class="tab-pane fade" id="session-payment" role="tabpanel" aria-labelledby="session-payment-tab">
                                                ...
                                                <div id="yapilandirmaDiv">
                                                    <button type="button" data-toggle="modal" data-target="#TaksitYapilandir" class="btn btn-sm bg-gradient-danger mb-1 waves-effect waves-light float-right"><i class="fa fa-refresh"></i> Yeni Ödeme Yapılandır</button>
                                                </div>
                                                <br>
                                                <hr>
                                                <div class="col-12">
                                            ...
                                            <div class="tab-pane fade" id="session-product" role="tabpanel" aria-labelledby="session-product-tab">
                                                <div class="table-responsive">
                                                    ...
                                                    <i class="fa fa-plus"></i> Bu Müşteriye Ürün Kullan</button>
                                                </div>
                                                <br>
                                                <hr>
                                                <div class="col-12">
                            ...
                            reader.onload = function (e) {
                                ...
                                .then((newBase64data) => {
                                    $.ajax({
                                        ...
                                        type:"post",
                                        complete:function(){
                                            toastr.success('Fotoğraf yüklendi.', { positionClass: 'toast-top-right', containerId: 'toast-top-right' });
                                        }
                                    });
                                })
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        ...
                        type:"post",
                        complete:function(){
                            toastr.success('Fotoğraf silindi.', { positionClass: 'toast-top-right', containerId: 'toast-top-right' });
                        }
                    });
                    $(this).parent().remove();
        ...
        var dataTable=$('#tblPayment').DataTable({
            ...
            "fnRowCallback": function( nRow, aData, iDisplayIndex ) {
                ...
                if(!iDisplayIndex){
                    ...
                    $('#yapilandirmaDiv').append(`<button type="button" data-toggle="modal" class="btn btn-sm bg-gradient-danger mb-1 waves-effect waves-light float-left yapilandirmaOnayi"><i class="fa fa-refresh"></i> Taksitlendirmeyi Sıfırdan Yapılandır</button>
                ...
                success: function(res) {
                    ...
                    if(sessionPhotos.length>0){
                        ...
                        $.each(sessionPhotos, function (key, value) {
                            var html = `<div class="dz-preview dz-file-preview">
                                <div class="dz-image">
                                    <a data-toggle="lightbox" data-gallery="example-gallery" data-title="Seans Görseli" href="/adropzone/upload/`+sessionPhotos[key]['photo']+`">
