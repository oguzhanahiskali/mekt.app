                ...
                <div class="content-wrapper">
                    <div class="content-header row">
                        ...
                        <div class="row breadcrumbs-top">
                            <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Hizmetler</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.php">Özet Ekranı</a>
                                </li>
                                <li class="breadcrumb-item active">Hizmet Listesi
                                </li>
                                </ol>
                            </div>
                            </div>
                                ...
                                <section id="data-list-view" class="users-list-wrapper data-list-view-header">
                                                            ...
                                                            <div class="ag-grid-btns d-flex justify-content-between flex-wrap mb-1">
                                                                ...
                                                                <div class="btn-export">
                                                                    ...
                                                                    <button type="button" class="btn bg-gradient-primary default action-add" >
                                                                        <i class="feather icon-user-plus"></i> <b data-i18n="Add New Services">Yeni Hizmet Ekle</b>
                                                                    </button>
                                                                    </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <div id="add-edit-data-sidebar" class="add-new-data-sidebar">
                                        ...
                                        <div id="add-edit-data" class="add-new-data">
                                            <div class="div mt-2 px-2 d-flex new-data-title justify-content-between">
                                                <div>
                                                    <h4 class="text-uppercase" >HİZMET DÜZENLE</h4>
                                                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-7 data-field-col">
                                                                <div class="form-group">
                                                                    <label for="hizmet">HİZMET ADI:<span class="danger">*</span></label>
                                                                    <div class="input-group">
                                                                        <input class="form-control" id="inp-edit-hizmet-adi" name="inp-edit-hizmet-adi">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-sm-6 data-field-col">
                                                                <div class="form-group">
                                                                    <label for="hizmet">SEANS SAYISI:<span class="danger">*</span></label>
                                                                    <div class="input-group">
                                                                    <select class="select2seans select2 form-control required" id="inp-edit-seans-sayisi" name="inp-edit-seans-sayisi"></select>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6 data-field-col">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        <select class="select2sure select2 form-control required" id="inp-edit-hizmet-suresi" name="inp-edit-hizmet-suresi"></select>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="card alert alert-primary" role="alert">
                                                                    ...
                                                                    <p class="mb-0 text-justify" style="font-size:.8em">Bu alan zorun değildir. Ancak müşteri seans işlemlerinde bu hizmete bağlı “Uygulama Bölgeleri” belirlemek istiyorsanız, gerekli bölgeleri işaretlemeniz önem arz etmektedir. Aksi halde, seans işlemlerinizde bu hizmete bağlı uygulama bölgeleri yansımayacaktır.</p>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                            ...
                                            <div class="add-data-footer d-flex justify-content-around px-3 mt-2 my-footer">
                                                <div class="add-data-btn">
                                                    <button class="btn btn-primary round" id="hizmetGuncelle">Güncelle</button>
                                                </div>
                                    ...
                                    <div id="add-new-data-sidebar" class="add-new-data-sidebar">
                                        ...
                                        <div id="add-new-data" class="add-new-data">
                                            <div class="div mt-2 px-2 d-flex new-data-title justify-content-between">
                                                <div>
                                                    <h4 class="text-uppercase" >HİZMET EKLE</h4>
                                                </div>
                                                <div class="hide-data-sidebar">
                                                    <i class="feather icon-x"></i>
                                                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-7 data-field-col">
                                                                <div class="form-group">
                                                                    <label for="hizmet">HİZMET ADI:<span class="danger">*</span></label>
                                                                    <div class="input-group">
                                                                        <input class="form-control" id="inp-add-hizmet-adi" name="inp-add-hizmet-adi">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-5 data-field-col">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        <div class="input-group-prepend">
                                                                            <select class="form-control bolder required" name="inp-add-currency" id="inp-add-currency" title="Döviz Seçiniz"></select>
                                                                        </div>
                                                                        <input type="number" class="form-control" id="inp-add-fiyat" aria-label="" name="inp-add-fiyat" aria-invalid="false">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6 data-field-col">
                                                                <div class="form-group">
                                                                    <label for="hizmet">SEANS SAYISI:<span class="danger">*</span></label>
                                                                    <div class="input-group">
                                                                    <select class="select2seans select2 form-control required" id="inp-add-seans-sayisi" name="inp-add-seans-sayisi"></select>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6 data-field-col">
                                                                <div class="form-group">
                                                                    <label for="hizmet">SEANS SÜRESİ:<span class="danger">*</span></label>
                                                                    <div class="input-group">
                                                                        <select class="select2sure select2 form-control required" id="inp-add-hizmet-suresi" name="inp-add-hizmet-suresi"></select>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-12 col-12">
                                                                <div class="card alert alert-primary" role="alert">
                                                                    <h4 class="alert-heading">Uygulama Bölgeleri</h4>
                                                                    <div class="row no-gutters">
                                                                        <select class="select2 form-control required border-warning" id="AddhizmetBolgesi" name="AddhizmetBolgesi[]" ></select>
                                                                    </div>
                                                                    <p class="mb-0 text-justify" style="font-size:.8em">Bu alan zorun değildir. Ancak müşteri seans işlemlerinde bu hizmete bağlı “Uygulama Bölgeleri” belirlemek istiyorsanız, gerekli bölgeleri işaretlemeniz önem arz etmektedir. Aksi halde, seans işlemlerinizde bu hizmete bağlı uygulama bölgeleri yansımayacaktır.</p>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="add-data-footer d-flex justify-content-around px-3 mt-2 my-footer">
                                                <div class="add-data-btn">
                                                    <button class="btn btn-primary round" id="hizmetEkle">Ekle</button>
                                                </div>
                                                <div class="cancel-data-btn">
                                                    <button class="btn btn-outline-danger round">İptal</button>
                                                </div>
