...
if(empty($_POST)){
  ...
  if($kalanTaksitlenecekOdeme>0 AND $numbOfInstallment==1){
    ...
    if ( $qquery->rowCount() ){
      $jsonResults[] = [ 'Result' => false, 'code'=>100141];
      $continue = false;
    }
    ...
    if($continue != false){
      ...
      if($kalanTaksitlenecekOdeme!=0){
        ...
        }else if($numbOfInstallment==2){
          $kalanTaksitlenenTutar = $kalanTaksitlenecekOdeme;
          $roundResultPriceTaksit = $kalanTaksitlenenTutar;
        }
