...
foreach($events as $event){
    if($event['SEANS_DURUM'] == 0){ $colors = "#B8C2CC";}else
    if($event['SEANS_DURUM'] == 1){ $colors = "#E83E8C";}else
    if($event['SEANS_DURUM'] == 2){ $colors = "#28C76F";}

    if($event['Completion_Status'] == 0){ $colors = "#620091"; }
