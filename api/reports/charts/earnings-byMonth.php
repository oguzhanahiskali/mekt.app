...
for($d=1; $d<=$maxDate; $d++)
{
    ...
    if (date('m', $time)==$month){
      ...
      $QeueryServices = "SELECT * FROM view_hizmet_tahsilatlar WHERE ISLEM_TARIHI LIKE '$dayss%' AND FIRMA_ID = $user_Firma AND DURUM = 1 AND TAHSILAT_DURUM = 2 ORDER BY TAHSILAT_TIPI";
