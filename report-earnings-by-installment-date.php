...
<body class="vertical-layout vertical-menu-modern 2-columns  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
                        ...
                        <div class="content-header-left col-md-9 col-12 mb-2">
                            <div class="row breadcrumbs-top">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="index.php">Özet Ekranı</a></li>
                                        <li class="breadcrumb-item active">Ciro Raporu</li>
                                    </ol>
                                </div>
                                </div>
                            </div>
    ...
    <script type="text/javascript" src="/app-assets/dtRange/daterangepickerByInstallment.js"></script>
    ...
    <script>
        ...
        $(window).on("load", function () {
            ...
            $.getJSON('/api/reports/charts/earnings-byMonth-installment.php', function(response) {
        ...
        $('#AddhizmetBolgesi').select2({
            ...
            if ($.urlParam('between') == 'true') {
                $.ajax({
                    type: "GET",
                    url: "/app-assets/data/report-service-earnings-by-installment.php?between=true&start=" + $.urlParam('start') + "&end=" + $.urlParam('end'),
