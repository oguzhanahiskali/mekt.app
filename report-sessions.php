...
<body class="vertical-layout vertical-menu-modern 2-columns  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
                    ...
                    <div class="content-header row">
                        <div class="content-header-left col-md-9 col-12 mb-2">
                            <div class="row breadcrumbs-top">
                                <div class="col-12">
                                <h2 class="content-header-title float-left mb-0">Seans Raporu</h2>
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.php">Özet Ekranı</a>
                                    </li>
                                    <li class="breadcrumb-item active">Seans Raporu
                                    </li>
                                    </ol>
                                </div>
                                </div>
                                    ...
                                    <section id="data-list-view" class="users-list-wrapper data-list-view-header">
                                        ...
                                        <div class="card">
                                            <div class="card-header d-flex justify-content-between align-items-end">
                                                <h4 class="card-title"><i class="feather icon-list"></i> Seans & Kontrol Seanslar Dökümü</h4>
                                        ...
                                        <div id="add-new-data-sidebar" class="add-new-data-sidebar">
                                            ...
                                            <div id="add-new-data" class="add-new-data">
                                                ...
                                                <form id="FormDateBetweenFilter" action="/report-sessions" method="get" novalidate>
    ...
    <script type="text/javascript" src="/app-assets/dtRange/daterangepickerSessions.js"></script>
