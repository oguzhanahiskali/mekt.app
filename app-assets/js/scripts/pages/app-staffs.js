  ...
  var customIconsHTML = function (params) {
    ...
    deleteIconHTML.addEventListener("click", function () {
      var ids = $(this).attr("ids");
        ...
        text: "Bu persoenli silmek istediğinize emin misiniz?",
        icon: "warning",
        ...
        confirmButtonText: "Evet",
			...
			.then((result) => {
              ...
              var obj = JSON.parse(result);
							...
							if (obj['result'] == true) {
                swal("Silindi!", "Bu personel başarıyla silindi.", "success");
                location.reload();
  ...
  var columnDefs = [
    ...
    },
    {
      ...
      cellRenderer: function(params) {
        ...
        var tAccess = null;
        if(pAccess==0){ tAccess = '<i class="feather icon-x text-danger mr-50" title="Erişemez"></i>'; }else
        if(pAccess==1){ tAccess = '<i class="feather icon-check-circle text-success mr-50" title="Erişebilir"></i>'; }
        return tAccess;
    ...
    },
    {
      ...
      cellRenderer: function(params) {
        ...
        var tMission = null;
        if(pMission==1){ tMission = 'Yönetici'; }else
