...
$(document).ready(function () {
  ...
  var customIconsHTML = function (params) {
    ...
    var eventIconHTML = '<input type="button" class="btn bg-gradient-success round mr-50 mb-100 waves-effect waves-light" value="'+params.data.Education+'" onclick="window.location=`/app-education-view.php?id='+params.data.ID+'`;">';
  ...
  if (document.getElementById("myGrid")) {
    ...
    agGrid
      .simpleHttpRequest({
        url: "app-assets/data/app-education-edit"
      })
      .then(function (data) {
