  ...
  var customIconsHTML = function (params) {
    ...
    deleteIconHTML.addEventListener("click", function () {
      ...
      Swal.fire({
          ...
          text: "Bu eğitimi silerek, iligli alt eğitim grupları ve atanan şirket ve vatandaş bilgilieri tümüyle silinecektir. Onaylamak istediğine emin misin?",
          icon: 'warning',
                  ...
                  success: function(result) {
                    ...
                    if(obj['code']==1000){
                        Swal.fire({
                            ...
                            title: 'Başarılı',
                            text: 'Bu eğitim başarıyla silindi',
                            icon: 'success',
                            timer: 1200
                        });
                        location.reload();
