                    ...
                    return (
                            ...
                            for (var T = 0; T < l.length; T++) {
                                ...
                                for (var x = 0, M = r; x < M.length; x++) {
                                    ...
                                    e.weekStart && z.push("fc-em-cell"),
                                        ...
                                        (C += '<th class="' + z.join(" ") + '" data-date="' + e.date.format() + '"' + (e.colspan > 1 ? ' colspan="' + e.colspan + '"' : "") + '><div class="fc-cell-content">' + e.spanHtml + "</div></th>");
                                }
                                C += "</tr>";
                            }
                            C += "</tbody></table>";
                        ...
                        (t.prototype.slatCellHtml = function (e, t) {
                            ...
                            return (
                                ...
                                t && r.push("fc-em-cell"),
                                '<td class="' + r.join(" ") + '" data-date="' + e.format() + '"><div></div></td>'
                            );
                        }),
                ...
                R = (function (e) {
                    ...
                    return (
                        ...
                        (t.prototype.renderSkeleton = function () {
                            ...
                            var r = s('<div class="fc-rows"> <table class="' + t.getClass("tableGrid") + '"> <tbody></tbody> </table> </div>').appendTo(this.timeBodyScroller.canvas.contentEl);
                ...
                c = (function (e) {
                    ...
                    return (
                        ...
                        (t.prototype.renderEventSkeleton = function (e) {
                            ...
                            e.html('<td class="' + t.getClass("widgetContent") + '"> <div> <div class="fc-event-container"></div> </div> </td>'),
                    ...
                    return (
                        (e.prototype.renderSkeleton = function () {
                            ...
                            (this.headScroller = new i["default"]({ overflowX: "clipped-scroll", overflowY: "hidden" })),
                                ...
                                this.bodyScroller.canvas.contentEl.html('<div class="fc-rows"> <table class="' + e.getClass("tableGrid") + '">' + this.colGroupHtml + "<tbody></tbody> </table> </div>"),
                ...
                a = (function (e) {
                    ...
                    return (
                        ...
                        (t.prototype.renderGutterHtml = function () {
                            for (var e = "", t = this.depth, r = 0; r < t; r++) e += '<span class="fc-icon"></span>';
                ...
                s = (function (e) {
                    ...
                    return (
                        ...
                        (t.prototype.renderSpreadsheetSkeleton = function (e) {
                            ...
                            return t.prepend('<span class="fc-expander"><span class="fc-icon"></span></span>'), n('<td class="fc-divider"></td>').attr("colspan", this.view.colSpecs.length).append(n("<div>").append(t)).appendTo(e);
                        }),
                        (t.prototype.renderEventSkeleton = function (e) {
                            return e.append('<td class="fc-divider"> <div></div> </td>');
                        }),
                        t
                    );
                })(i["default"]);
