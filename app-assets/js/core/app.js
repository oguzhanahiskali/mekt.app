...
(function (window, document, $) {
  ...
  var $danger = "#3DC9B3";
  var $primary = "#3DC9B3";
  var $textcolor = "#3DC9B3";

  $(window).on("load", function () {
    var rtl;
    var compactStatus = localStorage.getItem("menu-toggle");

    if(compactStatus=="true"){
      var compactMenu = true;
    }else if(compactStatus=="false"){
    ...
    $(".custom-menu li").click(function(){
      ...
      switch($(this).attr("data-action")) {
          ...
          case "first":  window.history.back(); break;
          case "second": location.reload(); break;
    ...
    //var compactMenu = compactStatuss; // Set it to true, if you want default menu to be compact
  ...
  $(document).ready(function () {
    ...
    $("#mainmenu").mouseout(function(){
      $(".ep-logo").hide();
      if (localStorage.getItem("menu-toggle")=="true") {
        $(".ep-logo").hide();
      }else{
        $(".ep-logo").show();
      }
  ...
  $(".dropdown-language .dropdown-item").on("click", function () {
    ...
    toastr.remove();
    toastr.clear();
    if(selectedLang==' Türkçe'){
      toastr.success(selectedLang+' dili uygulandı.', 'Başarılı!', { "timeOut": 2500 });
      $.ajax({ type: "POST", url: "/api/changeLang.php", data: 'lang=tr' });
      localStorage.removeItem('LangStatus');
      localStorage.setItem('LangStatus','tr');

    }else if(selectedLang==' English'){
      toastr.success('He applied the '+selectedLang+' language.', 'Success!', { "timeOut": 2500 });
      $.ajax({ type: "POST", url: "/api/changeLang.php", data: 'lang=en' });
      localStorage.removeItem('LangStatus');
    ...
    if (e.keyCode !== 38 && e.keyCode !== 40 && e.keyCode !== 13) {
      ...
      if (value != "") {
        ...
        var $startList = "",
          ...
          '<a href="#" class="pb-25">' +
          '<h6 class="text-primary mb-0">Modüller</h6>' +
          '</a>' +
          '</li>',
          $activeItemClass = "",
          $bookmarkIcon = "",
