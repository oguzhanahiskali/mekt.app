    ...
    a.extend(a.fn, {
        ...
        a.extend(a.validator, {
            ...
            messages: {
                ...
                maxlength: a.validator.format("Lütfen en fazla {0} karakter girin."),
                minlength: a.validator.format("Lütfen en az {0} karakter girin."),
                rangelength: a.validator.format("Lütfen {0} ile {1} karakter uzunluğunda bir değer girin."),
                range: a.validator.format("Lütfen {0} ile {1} arasında bir değer girin."),
                max: a.validator.format("İzin verilen maksimum değer {0}"),
                min: a.validator.format("Lütfen {0}'e eşit veya daha büyük bir değer girin."),
                step: a.validator.format("Lütfen {0}'in katlarını girin."),
            },
            autoCreateRanges: !1,
            prototype: {
                init: function () {
