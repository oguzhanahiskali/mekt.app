            ...
            <div class="header-navbar-shadow"></div>
                <div class="content-wrapper">
                    <div class="content-header row">
                        ...
                        <div class="content-header-right text-md-right col-md-2 col-12 d-md-block text-right">
                            <div class="card pt-1 pr-1">
                                <h2 id="myGridCount" class="text-bold-700 mb-0">{0}</h2>
                                <p style="margin-bottom: .5em;">Toplam Müşteri Sayısı</p>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div  class="add-new-data-sidebar">
                                        ...
                                        <div id="modalT" class="add-new-data">
                                            <div class="div mt-2 px-2 d-flex new-data-title justify-content-between">
                                                <div>
                                                    <h4 class="text-uppercase" data-i18n="addNewCustomer">Yeni Müşteri Ekle</h4>
                                                </div>
                                                <div class="hide-data-sidebar">
                                                    <i class="feather icon-x"></i>
                                                </div>
                                            </div>
                                            <div class="data-items pb-3" style="max-height: 75%;">
                                                        ...
                                                        <form id="formAddNewCustomer" class="row">
                                                            ...
                                                            <div class="col-sm-6 data-field-col">
                                                                <fieldset class="form-label-group">
                                                                    ...
                                                                    <label for="birthday"><span data-i18n="DayOfBirth">Doğum Tarihi</span></label>
                                                                </fieldset>
                                                            </div>
                                                            <div class="col-sm-6 data-field-col">
                                                                <fieldset class="form-label-group">
                                                            ...
                                                            <div class="col-sm-6 data-field-col">
                                                                <label style="padding: 0.25rem 0;font-size: 0.7rem;" data-i18n="ContactPermissions">İletişim Tercihleri:</label>
                                                                <fieldset class="form-label-group">
                                                                        ...
                                                                        <li class="d-inline-block mr-2">
                                                                            <fieldset>
                                                                                <div class="custom-control custom-checkbox">
                                                                                    ...
                                                                                    <label class="custom-control-label" for="contactSMS" data-i18n="SMS">SMS</label>
                                                                                </div>
                                                                            </fieldset>
                                                                        </li>
                                                                        <li class="d-inline-block mr-2">
                                                                            <fieldset>
                                                                                <div class="custom-control custom-checkbox">
                                                                                    ...
                                                                                    <label class="custom-control-label" for="contactCall" data-i18n="CALL">Çağrı</label>
                                                                                </div>
                                                                            </fieldset>
                                                                        </li>
                                                                    </ul>
                                                            ...
                                                            <div class="col-sm-12 data-field-col">
                                                                ...
                                                                <textarea id="Address" name="data-Address" class="form-control uppercase" rows="2" cols="50" data-index="7" data-i18n="[placeholder]Address"></textarea>
                                                                    <label for="Address"><span data-i18n="Address">Adres</span></label>
                                                                </fieldset>
                                                            </div>
                                                        </form>
                                                </div>
                                            ...
                                            <div class="add-data-footer d-flex justify-content-around px-3">
                                                <div class="add-data-btn">
                                                    <button id="btnNewCustomer" class="btn btn-primary round" data-i18n="Save">Kaydet</button>
                                                </div>
                                                <div class="">
                                                    <button id="btnFormClear" class="btn btn-outline-danger round" data-dismiss="modal" data-i18n="Cancel">İptal</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
