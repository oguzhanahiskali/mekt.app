...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="https://www.estetikpanel.com/app-assets/vendors/css/calendars/light-fullcalendar.min.css">
                ...
                <div class="navbar-collapse" id="navbar-mobile">
                    ...
                    <ul class="nav navbar-nav float-right">
                        ...
                        <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            ...
                            <div class="dropdown-divider"></div><a class="dropdown-item" href="auth-login.php?page=<?php echo $_SERVER['REQUEST_URI']; ?>"><i class="feather icon-power"></i> Logout</a>
                            </div>
                        </li>
                    </ul>
                </div>
            ...
            $('#fc-default').fullCalendar(
            {
                ...
                element.bind('click', function(){
                    ...
                    success: function(result){
                        ...
                        window.location.href='seans-detay.php?kart_id='+getdatas;
                    }
                    });
                });
                },
                ...
                foreach($events as $event):
                    ...
                    if ( $result->rowCount() ){
                        ...
                        ?>
                            ...
                            id: "<?php echo $row['ID']; ?>",
                            resourceId: 'a',
                            title: "<?php echo $event['ADI_SOYADI'].' ['.$event['TITLE'].']'; ?>",
                            start: "<?php echo $row['START'];?>",
                            end: "",
                            allDay:false,
                            color: "<?php echo '#fbc02d'; ?>"
                    ...
                    title: "<?php echo $event['ADI_SOYADI'].' ['.$event['TITLE'].']'; ?>",
                    description: "<b>Hizmet:</b> <?php echo $event['TITLE'];?> <br><b>Estetisyen:</b> <?php echo $event['ESTETISYENADI'];?> <br><b>Tarih/Saat:</b> <?php echo $yeniTarih.' ~ '.$event['SEANS_SURE'];?>",
                    start: "<?php echo $event['START'];?>",
                    end: "<?php echo $event['END'];?>",
                    allDay:false,
                    color: "<?php if($event['START'] > $suan) echo '#' . strtoupper(dechex(rand(0,10000000))); else echo "grey"; ?>"
                },
                <?php endforeach; ?>],
            });
        });
